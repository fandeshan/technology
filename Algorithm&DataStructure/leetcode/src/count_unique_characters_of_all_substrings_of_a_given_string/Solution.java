...
//        return (int) res%1000000007;
    ...
    public static void main(String[] args) {
        System.out.println(new Solution().uniqueLetterString("IECIYJSQHMDHQPCOTCQTVYEQMEYGGVPBUPKVHAAGBQKAQQVMWTMZZSEGTYWTBCNOWPWIBFDGVPHJYBMXFGSEQHNYAOHCPRJGARZA"));
